...
const PresenterContext = createContext<PresenterContextType | undefined>(
  undefined
);
...
export const PresenterProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <PresenterContext
      value={{ openAddPresentationDialog, closeAddPresentationDialog }}
    >
      {children}
...
export const usePresenterContext = () => {
  ...
  if (context === undefined) {
    throw new Error(
      "usePresenterContext must be used within a PresenterProvider"
    );
  }
  return context;
};
